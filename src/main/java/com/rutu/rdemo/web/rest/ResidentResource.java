...
import com.rutu.rdemo.service.ResidentService;
...
/**
 * REST controller for managing {@link com.rutu.rdemo.domain.Resident}.
 */
@RestController
@RequestMapping("/api")
public class ResidentResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/residents/{id}", consumes = "application/merge-patch+json")
