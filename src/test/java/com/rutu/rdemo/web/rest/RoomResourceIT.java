...
class RoomResourceIT {
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().roomname(DEFAULT_ROOMNAME);
        return room;
    }
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().roomname(UPDATED_ROOMNAME);
        return room;
    }
    ...
    void createRoom() throws Exception {
        ...
        assertThat(testRoom.getRoomname()).isEqualTo(DEFAULT_ROOMNAME);
    }
    ...
    void putNewRoom() throws Exception {
        ...
        updatedRoom.roomname(UPDATED_ROOMNAME);
        ...
        Room testRoom = roomList.get(roomList.size() - 1);
        assertThat(testRoom.getRoomname()).isEqualTo(UPDATED_ROOMNAME);
    }
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomname(UPDATED_ROOMNAME);
